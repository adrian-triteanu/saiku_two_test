...
/**
 * Patched version of org.saiku.web.rest.util.StatisticsResource.
 * Adapted to changes in ServerInfo interface
 *
 * @author akuehnel
 */
@Component
...
//    }
    ...
    public MondrianStats getMondrianStats() {
        ...
        if (mondrianServer != null) {
            ...
            int statementCurrentlyOpenCount = server.getStatementCurrentlyOpenCount();
