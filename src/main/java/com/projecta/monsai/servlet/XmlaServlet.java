...
public class XmlaServlet extends DefaultXmlaServlet {
    ...
    public final String MONDRIAN_TIMEOUT = ".*Query timeout of.*seconds reached";
    public final String MONDRIAN_CANCELLATION = ".*java.util.concurrent.CancellationException";
